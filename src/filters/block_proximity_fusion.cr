...
module Boilerpipe::Filters
  class BlockProximityFusion
    def initialize(@max_blocks_distance : Int32, @content_only : Bool, @same_tag_level_only : Bool)
    end
    ...
    def process(doc)
      ...
      blocks : Array(Document::TextBlock)
      blocks = text_blocks[offset..-1]

      blocks_to_remove = Array(Document::TextBlock).new
