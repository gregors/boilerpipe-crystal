module Boilerpipe
  module Document
    class TextBlock
      ...
      getter :text, :num_words, :num_words_in_wrapped_lines, :num_words_in_anchor_text,
                  :num_wrapped_lines, :offset_blocks_start, :offset_blocks_end,
                  :link_density, :labels, :tag_level, :num_full_text_words
      getter text_density : Float64
      ...
      def merge_next(other)
        ...
        if other.labels
          if @labels.nil?
            ...
            @labels =  @labels | other.labels.clone
          end
        end
